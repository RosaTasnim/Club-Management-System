...
<body>
  ...
  <div class="container mt-5">
    <table class="table table-dark table-bordered table-striped table-hover text-center">
      <h5 class="text-secondary bg-dark mb-0 py-3 text-center"><center><img src="misc/dlogo.png"></center>Office of Co-curricular Activities</h5>
      <thead>
        <tr>
          <th>Officer ID</th>
          <th>Officer</th>
      ...
      <tbody>
        <?php while($row1 = mysqli_fetch_assoc($rows1)) { ?>
          <?php 
            $sql2 = "SELECT * FROM oca_contact WHERE OCA_ID = ".$row1["OCA_ID"]."";
