      ...
      <div class="col-md-4">
        <div class="card" style="border-radius: .5rem;">
          <div class="card-body pt-4 pb-1">
            <form action="modupdate.php" method="POST">
              ...
              <div class="form-group row mt-3">
                ...
                <div class="col-sm-8">
                  <input type="text" class="form-control" id="inputID" name="id" value="<?php echo $row1["Member_ID"]; ?>" readonly>
                </div>
              </div>
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-8">
                  <select class="form-control" id="inputDept" name="dept" required>
                    <option value="" selected><?php echo $row1["Department"]; ?></option>
                    <?php
              ...
              <div class="form-group row">
                <div class="col-sm-10 mt-2">
                  <button class="btn btn-primary" name="id" value="<?php echo $id; ?>">Update</button>
                  <a class="btn btn-danger ml-2" href="clubmembers.php?warn=Editing Member Details Cancelled">Cancel</a>
                </div>
              </div>
            </form>
          </div>
