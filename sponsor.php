        ...
        <div class="card-body pt-4 pb-1">
          <form action="apply.php" method="POST">
            ...
            <div class="form-group row mt-3 pt-3">
              ...
              <div class="col-sm-8">
                <input type="text" class="form-control" id="inputName" name="name" placeholder="Sponsor Brand/Bank" required>
              </div>
            </div>
            <div class="form-group row">
              <label for="inputAgent" class="col-sm-4 col-form-label">Agent</label>
              <div class="col-sm-8">
                <input type="text" class="form-control" id="inputAgent" name="agent" placeholder="Sponsor Agent" required>
              </div>
            </div>
            <div class="form-group row">
              <label for="inputEvent" class="col-sm-4 col-form-label">Sponsor For</label>
              <div class="col-sm-8">
            ...
            <div class="form-group row">
              <label for="inputContact" class="col-sm-4 col-form-label">Contacts</label>
              <div class="col-sm-8">
